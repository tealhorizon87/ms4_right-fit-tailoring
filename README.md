...
The font families used for the application are ... for all headings, ... for main body text, and ... for decorative text. All fonts have been sourced from [Google Fonts](https://fonts.google.com/).
